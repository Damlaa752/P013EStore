...
namespace P013EStore.Data.Abstract
{
    public interface IProductRepository : IRepository<Product>
    {
        ...
        Task<List<Product>> GetProductByIncludeAsyncs(Expression<Func<Product, bool>> expression);// tüm ürünleri marka ve kategorisiyle lambda expression filtre uygulayarak getirecek metot
    }
}
